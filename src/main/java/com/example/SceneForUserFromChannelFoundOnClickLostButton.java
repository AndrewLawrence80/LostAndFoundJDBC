...
public class SceneForUserFromChannelFoundOnClickLostButton
{
    ...
    public SceneForUserFromChannelFoundOnClickLostButton(Stage stage,String userName)
    {
    ...
    private void fillTable()
    {
        try
        {
            ...
            String sql = "select id,name,date,location,description,contact from itemslost";
            ...
            TableColumn<Item, Date> dateColumn = new TableColumn<>("丢失日期");
            ...
            TableColumn<Item, String> locationColumn = new TableColumn<>("丢失地点");
    ...
    private void fillTableByName(String stringSearch)
    {
        ...
        {
            Connection connection = ConnectionController.getConnection();
            String sql = "select id,name,date,location,description,contact from itemslost where name=?";
            BeanListHandler<Item> handler = new BeanListHandler<>(Item.class);
            QueryRunner queryRunner = new QueryRunner();
