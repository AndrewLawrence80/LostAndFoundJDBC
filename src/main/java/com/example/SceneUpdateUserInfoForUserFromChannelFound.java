...
public class SceneUpdateUserInfoForUserFromChannelFound
{
    ...
    public SceneUpdateUserInfoForUserFromChannelFound(Stage stage,String userName)
    {
    ...
    {
        SceneForUserFromChannelFoundOnClickUserInfoButton sceneForUserFromChannelFoundOnClickUserInfoButton=new SceneForUserFromChannelFoundOnClickUserInfoButton(stageUpdateUserInfo,userName);
        stageUpdateUserInfo.setScene(sceneForUserFromChannelFoundOnClickUserInfoButton.getScene());
