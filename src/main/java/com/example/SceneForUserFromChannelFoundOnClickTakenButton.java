...
public class SceneForUserFromChannelFoundOnClickTakenButton
{
    ...
    private ScrollPane scrollPaneInfo=null;
    ...
    public SceneForUserFromChannelFoundOnClickTakenButton(Stage stage,String userName)
    {
