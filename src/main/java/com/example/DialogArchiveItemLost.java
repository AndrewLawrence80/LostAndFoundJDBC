...
public class DialogArchiveItemLost
{
    ...
    public DialogArchiveItemLost(Item item)
    {
        this.item = item;
        createLayout();
        setOnAction();
            ...
            public void handle(ActionEvent event)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        String sqlDelete = "delete from itemslost where id=?";
                        QueryRunner queryRunner = new QueryRunner();
                        queryRunner.update(connection, sqlInsert, item.getName(), item.getDate(),"丢失", item.getLocation(), item.getDescription(), contactLost, contactFound);
