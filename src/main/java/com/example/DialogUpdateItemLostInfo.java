...
public class DialogUpdateItemLostInfo
{
    ...
    public DialogUpdateItemLostInfo(Item item)
    {
        this.item = item;
        createLayout();
        setOnAction();
            ...
            public void handle(ActionEvent event)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        String sql = "update itemslost set name=?,date=?,location=?,description=?,contact=? where id=?";
